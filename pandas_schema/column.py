...
class Column:
    def __init__(
            self, name: str,
            validations: typing.Iterable['validation._BaseValidation'] = [],
        ...
        :param name: The column header that defines this column.
            This must be identical to the header used
            in the CSV/Data Frame you are validating.
        :param validations: An iterable of objects implementing _BaseValidation
            that will generate ValidationErrors
    ...
    def validate(self, series: pd.Series) -> typing.List[ValidationWarning]:
        ...
        :return: An iterable of ValidationError instances
            generated by the validation
        """
        return [
            error for validation in self.validations
